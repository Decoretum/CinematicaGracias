...
export default function Directors () {
    ...
    return (
        <>  
            ...
            <Header currentUser={currentUser} loading={directors === null } />
                ...
                <Box className='ml-auto mr-auto mt-42'>
                    ...
                    <>
                        ...
                        <Box className='flex flex-row gap-10 pl-86 overflow-x-auto max-w-[80vw] max-h-[50vh] justify-center items-center mx-auto bg-black/30 p-6 rounded-lg text-white backdrop-blur-sm'>
